...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://pdexswap.finance" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://pdexswap.finance" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
